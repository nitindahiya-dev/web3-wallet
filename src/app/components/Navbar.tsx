        ...
        <div className='absolute flex justify-between px-5 top-0 w-[90vw] md:w-[60vw] bg-white text-black mt-7 py-3 rounded-full '>
            ...
            <div className="flex gap-5">
                <Link
                    ...
                    href="https://github.com/nitindahiya-dev/web3-wallet"
                >
                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-black size-8">
                ...
                <Link href={"https://solana-tools-xi.vercel.app/"} className="whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 shadow h-9 px-4 py-2 bg-black text-white w-max gap-0.5 flex items-center justify-center rounded-full hover:bg-dark-4">Home
                    <svg
                        width="15"
                        height="15"
                        viewBox="0 0 15 15"
