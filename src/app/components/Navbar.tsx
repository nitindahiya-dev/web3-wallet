...
import PrimaryButton from '../components/ui/PrimaryButton'; // Change to use capitalized import
        ...
        <div className='absolute flex justify-between px-5 top-0 w-[60vw] bg-white text-black mt-7 py-3 rounded-full '>
            ...
            <div className="flex gap-5">
                <Link
                    ...
                    href="https://github.com/zzzzshawn/Pandora"
                >
                ...
                <PrimaryButton /> {/* Corrected the casing */}
            </div>
        </div >
    )
}
